                  ...
                  <div className='py-20 bg-black opacity-90'>
                      ...
                      <div>
                          <div className='relative bg-slate-400 w-full'>
                              ...
                              <div className='absolute top-1/2 left-[20%] -translate-x-1/2 transform -translate-y-1/2 items-center flex flex-row ml-4 '>
                            ...
                            hover:opacity-100 transition duration-300 ease-in-out px-6 py-1 rounded text-white flex flex-row gap-2'
                                  ...
                                  <div className=' absolute ml-44 py-2 text-white'>
                                      <p>Profile</p>
                                      <p className='font-bold text-3xl md:w-96'>
                                          User Name
                                      </p>
                                  </div>
                              </div>
                          </div>
                          <div className='max-w-screen-xl mx-auto p-0 md:p-4 h-full'>
                              ...
                              <form method='dialog'>
                                  ...
                                  <div className='flex flex-col gap-1 '>
                                      ...
                                      <p className='ml-7 text-[10px] text-gray-400'>
                                          Only you and people share a secret
                                          link with will be able to listen to
                                          this track
                                      </p>
                                  </div>
                                  <button

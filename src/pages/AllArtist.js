...
const artistsData = [
  ...
  {
    urlImg:
      'https://vcdn1-giaitri.vnecdn.net/2020/12/22/EdSheeran-1608608466-4639-1608608573.jpg?w=500&h=300&q=100&dpr=2&fit=crop&s=yXB5BHHa0ts49EPE0f-WrQ',
  ...
  {
    urlImg:
      'https://media.pitchfork.com/photos/650de105eacc5b460e151343/master/w_1280%2Cc_limit/Taylor-Swift-1989-Taylors-Version.jpg',
  ...
  {
    urlImg:
      'https://vcdn1-giaitri.vnecdn.net/2023/05/11/BRAY232-1683787021-7647-1683791747.jpg?w=1200&h=0&q=100&dpr=1&fit=crop&s=S7Au9I3KFnd_PwQYsr6mog',
    ArtistName: 'Bray',
    role: 'Artist',
  },
        ...
        <div className="max-w-screen-xl mx-auto py-16 h-full">
          ...
          <div className="text-white grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-x-4 md:gap-x-6 lg:gap-x-8 gap-y-6">
            {artistsData.map((artist, index) => (
              <ArtistFav key={index} urlImg={artist.urlImg} ArtistName={artist.ArtistName} role={artist.role} />
            ))}
          </div>
        </div>
      </div>

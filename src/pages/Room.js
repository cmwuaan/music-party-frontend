    ...
    <div>
            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
              <div className="flex items-center">
                <span className="self-center text-2xl font-semibold whitespace-nowrap ">
                  <Link to="/signup">Music Party</Link>
                </span>
              </div>
      ...
      <div className="bg-black opacity-90 text-white">
        <main className=" max-w-screen-xl flex flex-col flex-wrap mx-auto p-4 items-center justify-center gap-4">
          <div className="">
            <img src={teamwork} alt="listenImg" className=" h-96 w-96" />
          </div>
          ...
          <div className="flex">
            ...
            />
            <button
              className="bg-gradient-to-r from-indigo-600 to-purple-700  text-white font-medium rounded-r-lg px-6 py-2"
              onClick={''}
            >
              Join
            </button>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div className="modal-container bg-[#1f2937] text-white w-96 rounded-lg p-6 z-50">
              <div className="flex justify-between items-center mb-4">
                ...
                <button className="text-white  text-2xl rounded-full px-2 hover:bg-slate-600" onClick={openCreateModal}>
                  &times;
                </button>
              </div>
              ...
              <button
                onClick={''}
                className="  shadow-sm rounded-lg py-2 px-6 bg-gradient-to-r from-indigo-600 to-purple-700   w-full mt-8"
              >
                Create
              </button>
            </div>
